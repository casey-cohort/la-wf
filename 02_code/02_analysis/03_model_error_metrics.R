...
for (dataset_name in datasets) {
  ...
  for (encounter_type in encounter_types) {
      ...
      # load data ---------------------------------------------------
    preintervention_filename <- paste0(path_repo, "01_data/02_clean/test_train/df-train-test_sf_", dataset_name, ".csv") 
    ...
    all_cases_filename <-  paste0(path_repo, "01_data/02_clean/test_train/df-predict-sf_", dataset_name, ".csv")
...
# -----------------------------------------------
 #  # Load Prophet-XGBoost model
  ...
  phxgb_filename <- paste0(path_repo, "03_output/1.1-model-tune-phxgb-final_", dataset_name,"_", encounter_type,  ".RData")
